...
// Function BP_ProjectileCannonball.BP_ProjectileCannonball_C.ReceiveActorBeginOverlap
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor**                 OtherActor                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_ProjectileCannonball_C::ReceiveActorBeginOverlap(class AActor** OtherActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ProjectileCannonball.BP_ProjectileCannonball_C.ReceiveActorBeginOverlap");

	ABP_ProjectileCannonball_C_ReceiveActorBeginOverlap_Params params;
