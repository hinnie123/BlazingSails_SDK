...
public:
	...
	struct FLinearColor                                Color;                                                    // 0x06A0(0x0010) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	int                                                PlayerId;                                                 // 0x0710(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class UUI_DefeatedScreen_C*                        DefeatedScreenRef;                                        // 0x0858(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	...
	void S_LoadShipCustomisation(int HullColor, int SailColor, int emblem, int bowfigure, int FlagColor, int RopeColor, int FlagEmblem, int LampColor);
	...
	void ClaimSpawnPoint(class ABP_BoatSpawn_C* SpawnPoint);
	void S_ClaimSpawnPoint(class ABP_BoatSpawn_C* SpawnPoint);
	...
	void OC_DeathScreen(const struct FString& KillerPlayerName, float RespawnTime, bool headshot, bool Defeated);
	...
	void OC_AddNewChatMessage(const struct FST_SimpleMessage& ChatMessage, bool TeamChat, bool FormatText);
	...
	void DamageHull(int DamageAmount, TEnumAsByte<E_DamageType> DamageType, const struct FVector& RelativeLocation, const struct FVector& ImpactNormal, class ABP_BoatMeshBase_C* BoatRef);
	void DamageSail(int damage, class ABP_MastBase_C* MastRef);
	void DamagePlayer(int DamageAmount, class ABP_Character_C* PlayerToDamageRef, bool headshot);
	...
	void HitIndicator(bool headshot);
