...
void ABP_WeaponSniper2_C::SecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
...
void ABP_WeaponSniper2_C::StopSecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
