...
void ABP_WeaponSniper_C::SecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
...
void ABP_WeaponSniper_C::StopSecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
