...
// Function BP_HangLamp.BP_HangLamp_C.SetLightQuality
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           CastShadows                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_HangLamp_C::SetLightQuality(bool CastShadows)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HangLamp.BP_HangLamp_C.SetLightQuality");

	ABP_HangLamp_C_SetLightQuality_Params params;
...
// Function BP_HangLamp.BP_HangLamp_C.RefreshLanternSettings
// (BlueprintCallable, BlueprintEvent)

void ABP_HangLamp_C::RefreshLanternSettings()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HangLamp.BP_HangLamp_C.RefreshLanternSettings");

	ABP_HangLamp_C_RefreshLanternSettings_Params params;
