...
struct FEventReply UUI_PieMenu_C::OnMouseButtonDown(struct FGeometry* MyGeometry, struct FPointerEvent* MouseEvent)
{
...
void UUI_PieMenu_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
