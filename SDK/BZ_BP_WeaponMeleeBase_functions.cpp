...
void ABP_WeaponMeleeBase_C::HitOther(const struct FVector& Location, const struct FVector& Normal)
{
...
void ABP_WeaponMeleeBase_C::PrimaryFire(struct FVector* CameraLocation, struct FVector* Direction, bool* FullPrecision, bool* WasSprinting)
{
...
void ABP_WeaponMeleeBase_C::SecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
...
void ABP_WeaponMeleeBase_C::StopSecondaryFire(struct FVector* CameraLocation, struct FVector* Direction)
{
