...
// Function UI_ServerBrowserGame.UI_ServerBrowserGame_C.SetJoinText
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)

struct FText UUI_ServerBrowserGame_C::SetJoinText()
{
	static auto fn = UObject::FindObject<UFunction>("Function UI_ServerBrowserGame.UI_ServerBrowserGame_C.SetJoinText");

	UUI_ServerBrowserGame_C_SetJoinText_Params params;
