...
// Function BP_DeathCam.BP_DeathCam_C.AttachToPlayer
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           Defeated                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            TeamID                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_DeathCam_C::AttachToPlayer(bool Defeated, int TeamID)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathCam.BP_DeathCam_C.AttachToPlayer");

	ABP_DeathCam_C_AttachToPlayer_Params params;
...
// Function BP_DeathCam.BP_DeathCam_C.OC_AttachToShip
// (Net, NetReliable, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           Defeated                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// int                            TeamID                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_DeathCam_C::OC_AttachToShip(bool Defeated, int TeamID)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathCam.BP_DeathCam_C.OC_AttachToShip");

	ABP_DeathCam_C_OC_AttachToShip_Params params;
	params.Defeated = Defeated;
	params.TeamID = TeamID;
