...
public:
	...
	class UAudioComponent*                             ZoneMusic1;                                               // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAudioComponent*                             DeadZoneMusic;                                            // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	void ClosestPointToDeathzoneEdge(struct FVector* Closest_Location_To_Circle, bool* Outside_of_Zone_);
