...
void ABP_Controller_C::S_LoadShipCustomisation(int HullColor, int SailColor, int emblem, int bowfigure, int FlagColor, int RopeColor, int FlagEmblem, int LampColor)
{
...
// Function BP_Controller.BP_Controller_C.ClaimSpawnPoint
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABP_BoatSpawn_C*         SpawnPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Controller_C::ClaimSpawnPoint(class ABP_BoatSpawn_C* SpawnPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.ClaimSpawnPoint");

	ABP_Controller_C_ClaimSpawnPoint_Params params;
...
// Function BP_Controller.BP_Controller_C.S_ClaimSpawnPoint
// (Net, NetReliable, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABP_BoatSpawn_C*         SpawnPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Controller_C::S_ClaimSpawnPoint(class ABP_BoatSpawn_C* SpawnPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.S_ClaimSpawnPoint");

	ABP_Controller_C_S_ClaimSpawnPoint_Params params;
	params.SpawnPoint = SpawnPoint;
...
// Function BP_Controller.BP_Controller_C.OC_DeathScreen
// (Net, NetReliable, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void ABP_Controller_C::OC_DeathScreen(const struct FString& KillerPlayerName, float RespawnTime, bool headshot, bool Defeated)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.OC_DeathScreen");

	ABP_Controller_C_OC_DeathScreen_Params params;
...
void ABP_Controller_C::OC_AddNewChatMessage(const struct FST_SimpleMessage& ChatMessage, bool TeamChat, bool FormatText)
{
...
void ABP_Controller_C::DamageHull(int DamageAmount, TEnumAsByte<E_DamageType> DamageType, const struct FVector& RelativeLocation, const struct FVector& ImpactNormal, class ABP_BoatMeshBase_C* BoatRef)
{
...
void ABP_Controller_C::DamageSail(int damage, class ABP_MastBase_C* MastRef)
{
...
void ABP_Controller_C::DamagePlayer(int DamageAmount, class ABP_Character_C* PlayerToDamageRef, bool headshot)
{
...
void ABP_Controller_C::HitIndicator(bool headshot)
{
...
// Function BP_Controller.BP_Controller_C.SpectatorCam
// (BlueprintCallable, BlueprintEvent)

void ABP_Controller_C::SpectatorCam()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Controller.BP_Controller_C.SpectatorCam");

	ABP_Controller_C_SpectatorCam_Params params;
...
void ABP_Controller_C::S_PossesPlayer()
{
