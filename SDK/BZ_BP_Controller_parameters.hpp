...
struct ABP_Controller_C_ClaimSpawnPoint_Params
{
...
struct ABP_Controller_C_S_ClaimSpawnPoint_Params
{
	class ABP_BoatSpawn_C*                             SpawnPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct ABP_Controller_C_OC_DeathScreen_Params
{
...
struct ABP_Controller_C_SpectatorCam_Params
{
};
