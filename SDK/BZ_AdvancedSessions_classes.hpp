...
{
public:
	bool                                               bCallFriendInterfaceEventsOnPlayerControllers;            // 0x00A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCallIdentityInterfaceEventsOnPlayerControllers;          // 0x00A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCallVoiceInterfaceEventsOnPlayerControllers;             // 0x00A2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableTalkingStatusDelegate;                             // 0x00A3(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7C];                                      // 0x00A4(0x007C) MISSED OFFSET
